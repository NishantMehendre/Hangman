    ...
    public void createGame() {
        try {
            ...
            while (gameOver == false) {
                ...
                // Checks if player hasn't made an error yet and if true prints the game
                if (count == 0) {
                    System.out.println("  ____");
                    System.out.println(" |    |");
                    System.out.println("      |");
                ...
                // Checks if the player has made a third incorrect guess and prints the first
                // hand
                ...
                // Checks if the player has made a fourth incorrect guess and prints the second
                // hand
                ...
                // Checks if the player has made a fifth incorrect guess and prints the first
                // leg
                ...
                // Checks if the player has made a sixth and final incorrect guess and prints
                // the second leg
                // Ends the game
                ...
                // Prints the correct and incorrect guesses separately as long as the game
                // continues
                if (gameOver == false) {
                    for (int i = 0; i < ans.length; i++) {
                        System.out.print(ans[i]);
                    ...
                    // Goes through all of the entries the player made and checks for incorrect
                    // guesses
